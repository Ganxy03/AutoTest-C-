...
int SetQus1()
{
	...
	Tm();
	FILE* fp = NULL;
	fp = fopen("2021上半年选择模拟题库/第一套.txt", "r");
	if (fp == NULL)
	{
...
int SetQus2()
{
	...
	Tm();
	FILE* fp = NULL;
	fp = fopen("2021上半年选择模拟题库/第二套.txt", "r");
	if (fp == NULL)
	{
		printf("文件打开失败！请检查题库位置\n");
	}
...
int SetQus3()
{
	...
	Tm();
	FILE* fp = NULL;
	fp = fopen("2021上半年选择模拟题库/第三套.txt", "r");
	if (fp == NULL)
	{
		printf("文件打开失败！请检查题库位置\n");
	}
...
int SetQus4()
{
	...
	Tm();
	FILE* fp = NULL;
	fp = fopen("2021上半年选择模拟题库/第四套.txt", "r");
	if (fp == NULL)
	{
		printf("文件打开失败！请检查题库位置\n");
	}
...
int SetQus5()
{
	...
	Tm();
	FILE* fp = NULL;
	fp = fopen("2021上半年选择模拟题库/第五套.txt", "r");
	if (fp == NULL)
	{
		printf("文件打开失败！请检查题库位置\n");
	}
...
int SetQus6()
{
	...
	Tm();
	FILE* fp = NULL;
	fp = fopen("2021上半年选择模拟题库/第六套.txt", "r");
	if (fp == NULL)
	{
		printf("文件打开失败！请检查题库位置\n");
	}
